                    ...
                    <div class="col-md-7 p-0 card-right">
                        <div class="card tab2-card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{route('School-Login')}}" enctype="multipart/form-data">
                                    @csrf
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (status === 'success') {
                Swal.fire({
                    ...
                    window.location.href = 'school/add-profile'; // Replace with your desired URL
                });
